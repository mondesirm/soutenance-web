// Execute a function after the document has loaded
$(document).ready(function() {
	/*
		If '.slider' elements exist
			For each '.slider' element
				Call the sliderInit function and
				pass it the element as a parameter
	*/
	if ($('.slider').length) {
		$('.slider').each(function() { sliderInit($(this));	});
	}
})
